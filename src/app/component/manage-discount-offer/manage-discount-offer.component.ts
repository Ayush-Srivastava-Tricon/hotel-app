...
@Component({
  selector: 'app-manage-discount-offer',
  templateUrl: './manage-discount-offer.component.html',
  styleUrls: ['./manage-discount-offer.component.scss']
})
export class ManageDiscountOfferComponent {
  ...
  constructor(private _service:PropertyService,private alert:AlertService,private fb: FormBuilder){
    this.discountForm = this.fb.group({
      name: ['', Validators.required],
      type: ['normal'],
      enabled: [true],
      displayOnOctoSite: [true],
      displayOnBookingEngine: [true],
      showOnOTA: [false],
      validFrom: [''],
      validTo: [''],
      reservationsFrom: [''],
      ...
      daysBeforeArrival: [0],
      lengthOfStay: [1],
      fixedValueDiscount: [0, Validators.required],
      percentDiscount: [0]
    });
  }
